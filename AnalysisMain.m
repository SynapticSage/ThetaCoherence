clear all;
path(path,genpath('/Volumes/jadhav-lab/DATA/sjadhav/HPExpt/HPa_direct')) 
path(path,genpath('/Volumes/jadhav-lab/DATA/sjadhav/HPExpt/HPb_direct'))
path(path,genpath('/Volumes/jadhav-lab/DATA/sjadhav/HPExpt/HPc_direct'))% add entire data 
														% folder to path
														% and all
														% subfolders. For
														% now this is how
